...
int32_t muriscv_nn_fully_connected_s16_get_buffer_size(const nmsis_nn_dims *filter_dims)
{
    (void)filter_dims;
    return 0;
}
...
{
    return muriscv_nn_fully_connected_s16_get_buffer_size(filter_dims);
}
