...
int32_t muriscv_nn_convolve_1x1_s8_fast_get_buffer_size(const nmsis_nn_dims *input_dims)
{
    (void)input_dims;
    return 0;
}
 ...
 *
 */
int32_t muriscv_nn_convolve_wrapper_s8_get_buffer_size(const nmsis_nn_conv_params *conv_params,
